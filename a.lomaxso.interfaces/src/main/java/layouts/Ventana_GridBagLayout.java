...
public class Ventana_GridBagLayout extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ventana_GridBagLayout frame = new Ventana_GridBagLayout();
	...
	public Ventana_GridBagLayout() {
		...
		gbl_contentPane.columnWidths = new int[]{79, 0, 0, 0, 85, 0};
